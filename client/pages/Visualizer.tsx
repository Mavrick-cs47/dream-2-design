...
export default function Visualizer() {
  ...
  const prompt =
    "surreal neon city in the clouds, cinematic, fantasy, ultra-detailed";
  const url = useMemo(
    () =>
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <div className="glass-card p-6 md:p-8">
          ...
          <p className="text-white/70 mt-2">
            Auto-fetched placeholder art while your own visuals are being
            created.
          </p>
          <div className="mt-6">
            <img
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                className="px-4 py-2 rounded-full bg-brand-cyan/20 border border-brand-cyan/40 text-white"
              >
                Regenerate
              </button>
            </div>
