...
const OAUTH_CALLBACK_URL = process.env.OAUTH_CALLBACK_URL || "/api/auth/google/callback";
...
router.get("/google/callback", (req, res, next) => {
  ...
  passport.authenticate("google", { session: false }, (err: any, user: any) => {
    ...
    const redirectUrl = new URL(process.env.OAUTH_SUCCESS_REDIRECT || "http://localhost:8080/auth");
